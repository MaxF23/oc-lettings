...
# massa.
# Integer est nunc, pulvinar a tempor et, bibendum id arcu. Vestibulum ante ipsum primis in
...
# eleifend. Praesent dignissim,
# odio eu consequat pretium, purus urna vulputate arcu, vitae efficitur lacus justo nec purus.
# Aenean finibus faucibus lectus at porta. Maecenas auctor, est ut luctus congue, dui enim
# mattis enim,
...
def letting(request, letting_id):
    this_letting = Letting.objects.get(id=letting_id)
    context = {
        'title': this_letting.title,
        'address': this_letting.address,
    }
